...
export async function generateMetadata({
  ...
  return buildPseoMetadata("uppdrag", trade, city);
}

export default async function UppdragTradeCityPage({ params }: { params: Promise<Params> }) {
  const { trade, city } = await params;
  return <TradeCityLanding section="uppdrag" tradeSlug={trade} citySlug={city} />;
}
