...
export async function generateMetadata({
  ...
  return buildPseoMetadata("larlingsplatser", trade);
}

export default async function LarlingsplatserTradePage({ params }: { params: Promise<Params> }) {
  const { trade } = await params;
  return <TradeCityLanding section="larlingsplatser" tradeSlug={trade} />;
}
