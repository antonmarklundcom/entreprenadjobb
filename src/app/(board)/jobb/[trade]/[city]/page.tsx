...
export async function generateMetadata({
  ...
  return buildPseoMetadata("jobb", trade, city);
}

export default async function JobbTradeCityPage({ params }: { params: Promise<Params> }) {
  const { trade, city } = await params;
  return <TradeCityLanding section="jobb" tradeSlug={trade} citySlug={city} />;
}
